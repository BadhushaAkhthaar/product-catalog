					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Archlynk Product Catalog",
									"targetURL": "#productcatalog-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"productcatalog-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productcatalog",
									"url": sap.ui.require.toUrl("productcatalog")
								}
							}
						}
					}
